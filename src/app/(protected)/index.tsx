            ...
            return (
              ...
              >
                <View className='flex-row items-center justify-between mb-2'>
                  <Ionicons name={statusIcons[statusType] as any} size={20} color='white' />
                  <Text className='text-white/80 text-xs'>{statusLabels[statusType]}</Text>
                </View>
        ...
        {orders.map((order) => {
          ...
          return (
            ...
            >
              ...
              <View className='flex-row items-start justify-between mb-4'>
                <View className='flex-1'>
                  <View className='flex-row items-center mb-3'>
                    ...
                    >
                      <Ionicons name={statusIcons[order.status] as any} size={22} color={statusConfig.icon} />
                    </View>
                    <View className='flex-1'>
              ...
              >
                <View className='px-4 py-2 rounded-full' style={{ backgroundColor: statusTheme.badge }}>
                  <Text className='text-xs font-bold' style={{ color: statusTheme.text }}>
                ...
                {order.status !== 'completed' && (
                  ...
                  >
                    <View className='flex-row items-center'>
                      <Text className='text-white text-sm font-bold mr-2'>Xử lý</Text>
