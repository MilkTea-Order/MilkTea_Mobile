import { handleChangePasswordFormErrors, useChangePassword } from '@/features/user/hooks/useChangePassword'
import changePasswordSchema, { ChangePasswordSchema } from '@/features/user/schema/changePassword.schema'
                ...
                <View className='flex-row items-start'>
                  ...
                  <View className='flex-1'>
                    ...
                    <Text className='text-xs leading-5' style={{ color: colors.textSecondary }}>
                      Mật khẩu mới phải có ít nhất 6 ký tự. Vui lòng nhớ mật khẩu mới của bạn.
                    </Text>
                  </View>
                </View>
              </View>
